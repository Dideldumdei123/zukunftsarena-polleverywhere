...
| `map/index.html` | **Event map.** Interactive floorplan of the Convention Center (`map/floorplan.jpg`). Tap/click zooms in around the tapped point, pinch/scroll zooms, drag pans, double-tap or ⟲ resets. No dependencies. |
